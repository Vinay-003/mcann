...
class DS:
    ...
    def read_dataset(self):
        ...
        # dim=1 is the extreme score
        self.sensor_data_norm1 = np.concatenate((self.sensor_data_norm1, prob_like_outlier3), 1) # dim=1, from gm3

        # train another gmm with the input from random sampling, similar like training data sampling
        clean_data = []
        ...
        # predict posterior probabilities on each component
        data_prob30 = self.gmm0.predict_proba(sensor_data_prob) 
        # order them by prior probabilities, i.e. the weights
        ...
        # now, dim 2,3,4 are the ordered posterior probabilities
